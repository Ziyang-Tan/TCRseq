...
repo_path <- '/Users/tan/OneDrive - KI.SE/Results_P23359/C2_35/P23359_1002_VDJ_perCell.csv'
exp_path <- '/Users/tan/OneDrive - KI.SE/Results_P23359/C2_35/P23359_1002_DBEC_MolsPerCell.csv'
raw <- read_csv(repo_path, skip = 6) # skip the head info
exp <- read_csv(exp_path, skip = 6)
